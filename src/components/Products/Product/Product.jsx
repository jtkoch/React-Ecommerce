  ...
  return (
    <div>
      ...
      <div className="px-10 py-5 bg-white shadow-lg rounded-b overflow-hidden">
        ...
        <p dangerouslySetInnerHTML={{__html:product.description}} className="mb-2" />
        <button className="border-t border-grey-light pt-4 text-xs uppercase no-underline focus:outline-none w-full">
          <p>Add to cart</p>
